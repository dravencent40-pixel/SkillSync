    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      <div class="lg:col-span-7 animate-fade-up">
        ...
        <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05]">
          ...
          <span class="text-accent">siap kerja 24 jam.</span>
        </h1>
        ...
        <div class="mt-10 flex items-center gap-6 text-sm text-[#525252]">
          ...
          <div class="flex items-center gap-2">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-5 stagger">
    ...
    <div class="surface surface-hover spot-card p-7 rounded-2xl group">
      <div class="flex items-start gap-5">
        <div class="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 transition-all duration-300 group-hover:scale-110" style="background: <?= $a[5] ?>; color: <?= $a[4] ?>;">
